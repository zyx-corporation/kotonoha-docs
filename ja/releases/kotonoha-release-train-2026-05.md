...
| --- | --- | --- |
| obsidian-kotonoha-console | [v0.3.1](https://github.com/zyx-corporation/obsidian-kotonoha-console/releases/tag/v0.3.1)（[v0.3.0](https://github.com/zyx-corporation/obsidian-kotonoha-console/releases/tag/v0.3.0) も可） | [install_obsidian_kotonoha_console.md](../manual/install_obsidian_kotonoha_console.md) |
...
Obsidian 配置パス: `<vault>/.obsidian/plugins/kotonoha-console/`（v0.3.1 zip は `kotonoha-console/` フォルダ名。v0.3.0 zip はリネーム要）

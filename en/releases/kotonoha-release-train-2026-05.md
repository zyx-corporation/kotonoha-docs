...
| --- | --- | --- | --- | --- |
| [obsidian-kotonoha-console](https://github.com/zyx-corporation/obsidian-kotonoha-console) | **v0.3.0** | v0.3.0 tag @ train cut | First usable UI | **Stable (UI)** |
...
Obsidian install path: `<vault>/.obsidian/plugins/kotonoha-console/` (release zip folder: `kotonoha-console/`)
